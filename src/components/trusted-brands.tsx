...
const TrustedBrands = () => {
  ...
  return <section className="bg-gray-900 py-12 text-white">
      <div className="container mx-auto px-4">
        ...
        amount: 0.8
          ...
          {placeholderImages.map((image, index) => <motion.div key={index} className="h-12 flex items-center opacity-80 hover:opacity-100 transition-all duration-300" variants={itemVariants}>
